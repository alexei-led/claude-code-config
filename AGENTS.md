<!-- generated by scripts/build/generate-agents-md.py from flat/skills-codex/. Run `make build` to refresh. Edits to this file will be overwritten — edit the source skills (their frontmatter `description`) instead. -->
