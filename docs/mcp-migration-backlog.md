...
| `mcp__sequential-thinking__sequentialthinking`                                                          | None                                                         | **Open (small)** — single hit in `plugins/spec-system/commands/spec/work.md`. Replace with native thinking blocks (no tool dependency) when convenient.                                                                    |
