...
name: smart-explore
description: >-
  Token-efficient code navigation using local Pi tools. Use when you need a fast
  outline of files, symbols, imports, or call sites without loading whole files.
---
