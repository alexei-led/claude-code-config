...
description:
  ...
  "compare", "vs", "best practice", "which is better", "pros and cons", "what's new in".
  NOT for API references or library docs (use looking-up-docs for syntax, examples, and
