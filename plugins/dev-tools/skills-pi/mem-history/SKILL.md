---
description: Query project history and past decisions using local files and git history
  in Pi. Use when the user asks what changed, why a decision was made, or what the
