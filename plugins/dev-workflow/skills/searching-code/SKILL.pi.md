...
name: searching-code
description: >-
  Intelligent codebase search and zoom-out mapping using Pi tools. Use when the
  user asks how code works, to trace a flow, find implementations, zoom out, or
  map an area of a large repo.
---
