---
description:
  Playwright-based end-to-end browser testing of user flows. Use when running
  existing Playwright tests, generating browser checks, recording a visible session,
  or verifying a user journey end-to-end. NOT for unit tests, API-only tests, or
  logic tests where curl or JSDOM suffices — use improving-tests or fixing-code instead.
name: testing-e2e
---
