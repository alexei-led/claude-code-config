---
description:
  Find current, factual library/API/framework documentation through a
  tool-fallback chain. Use when the user says "look up docs", "how to use",
  "API for", "syntax for", "examples of", "show me the docs", or wants the
  ...
  researching-web. NOT for raw ctx7 CLI mechanics — that is context7-cli.
