---
description: Prefer modern CLI tools — rg, fd, bat, eza, sd, dust, procs — over
  grep, find, cat, ls, sed, du, ps. Use when writing bash scripts, optimizing command
  chains, working with file searches, or replacing legacy Unix tools in workflows.
  NOT for application code logic, test writing, or infrastructure configuration.
