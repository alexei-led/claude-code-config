...
# looking-up-docs: Documentation lookup via Context7
...
# asking-codex: Code review and implementation help
...
# asking-gemini: Architecture consultation and design decisions
