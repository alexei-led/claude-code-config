...
Three modes, picked by checking whether `.spec/` exists and whether the user passed a file path.
...
Write each `REQ-*.md` file. Suggest next: `spec new task <name>` or `spec work`.
